...
CHAPCHAP_PAYMENT_REGISTRY_ADDRESS = os.environ.get(
    "CHAPCHAP_PAYMENT_REGISTRY_ADDRESS",
    "",
).strip()
CHAPCHAP_PAYMENT_REGISTRY_ENABLED = _get_bool(
    "CHAPCHAP_PAYMENT_REGISTRY_ENABLED",
    default=bool(CHAPCHAP_PAYMENT_REGISTRY_ADDRESS),
)
